...
//    fadeGlass.sprite = null;
  ...
  //---------------------------------------------------------------------------------------------------------------
  public IEnumerator ShowPanel(string popupName, object data, GenricPopUpCallback CallBack = null)
  {
  ...
  //---------------------------------------------------------------------------------------------------------------
  public IEnumerator Show(PopupId popup, object data, GenricPopUpCallback CallBack = null)
  {
