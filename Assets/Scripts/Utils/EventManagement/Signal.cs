...
public class SignalDelegate<D> : GameEvent where D : Delegate
{
  public void Listen(Action<D> action) { ListenInternal(action.Method, action.Target); }
  public void Invoke(D d) { InvokeInternal(d); }
}
